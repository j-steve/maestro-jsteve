...
Activate this skill when performing standalone code reviews via the `/maestroj:review` command or during orchestration quality gates (post-phase checks and final completion gate). This skill provides the methodology for scoping, executing, and reporting code reviews.
